...
class ControllerExtensionThemecss extends Controller {
	...
	public function index() {
		...
		echo ".texthover .name,.gallery-right h3 a,.gallery-right .name{color:".$data['gallerysetting_namecolor']."!important;}";
		echo ".description,.gallery-right p{color:".$data['gallerysetting_desccolor']."!important;}";
