              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="ciblog_post-related_product" class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div id="ciblog_post-related_product<?php echo $ciblog_post_related_product['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $ciblog_post_related_product['name']; ?>
                      <input type="hidden" name="ciblog_post_related_product[]" value="<?php echo $ciblog_post_related_product['product_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
