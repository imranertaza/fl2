<?php
//==============================================================================
// Category & Product-Based Shipping v303.1
// 
...
//------------------------------------------------------------------------------
$_['help_charge_type']					= 'Select the basis for the charge:<br /><br />&bull; A simple flat charge, per item charge, or "Text" message displayed to the customer.<br /><br />&bull; A charge based on brackets (quantity, total, weight, etc.).<hr />For "Text" messages, the type determines the background:<br /><br />Error = red<br />Success = green<br />Warning = yellow<br /><br />Additionally, you can use the following shortcodes to insert information about the current cart:<br /><br />[distance], [postcode], [quantity], [total], [volume], [weight]<br /><br />To calculate numbers based on these values, enter the calculation within curly <b>{</b> and <b>}</b> brackets. Use <b>*</b> for multiplication and <b>/</b> for division. For example, to display the difference between the cart total and $75, you would enter:<br /><br /><span style="font-family: monospace">{75 - [total]}</span>';

$_['help_charge_charges']				= 'For "Simple Charges", enter the flat charge or per item charge (such as 5.00) or a percentage (such as 10%). For "Text" charges, enter the text and HTML for the message displayed when the rules are met.<hr />For "Bracket Charges", separate brackets by commas or new lines, and enter them in the format:<br /><br /><b>From - To = Cost / Per</b><br /><br />The "Per" value is optional. If you leave out the "From" value, it will default to the previous bracket&#39;s "To" value (or 0 for the first bracket).<br /><br />For example, to charge $6.00 for 1 to 3 items, and $2.00 per item for 4 or more items, you would choose "Quantity" and enter:<br /><div class="text-left" style="margin: 10px">1-3 = 6.00<br />4-9999 = 2.00 / 1</div>';
?>