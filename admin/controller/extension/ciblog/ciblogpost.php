...
class ControllerExtensionCiBlogCiBlogPost extends Controller {
	...
	protected function getList() {
		...
		$data['sort_date_added'] = $this->url->link('extension/ciblog/ciblogpost', $this->ciblog->octoken.'=' . $this->session->data[$this->ciblog->octoken] . '&sort=p.date_added' . $url, true);
		$data['sort_date_modified'] = $this->url->link('extension/ciblog/ciblogpost', $this->ciblog->octoken.'=' . $this->session->data[$this->ciblog->octoken] . '&sort=p.date_modified' . $url, true);
		$data['sort_date_available'] = $this->url->link('extension/ciblog/ciblogpost', $this->ciblog->octoken.'=' . $this->session->data[$this->ciblog->octoken] . '&sort=p.date_available' . $url, true);
