	...
	public function index() {
		...
		foreach ($modules as $module) {
			...
			if (isset($part[0]) && $this->config->get('module_' . $part[0] . '_status')) {
				/*CiBlog start*/
			if(strstr($module['code'], 'ciblog_')) {
				$module_data = $this->load->controller('extension/module/' . $part[0], array('position' => $module['position']));
			} else {
			...
			/*CiBlog start*/
			$setting_info['position'] = $module['position'];
			/*CiBlog end*/
