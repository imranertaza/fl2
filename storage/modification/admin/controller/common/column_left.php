		...
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($catalog) {
				$data['menus'][] = array(
					...
					// Advanced Products
					if ($this->user->hasPermission('access', 'extension/module/editinline')) {
						$data['menus'][] = array(
							'id'       => 'menu-Advanced_Products',
							'icon'	   => 'fa fa-flash', 
							'name'	   => 'Advanced Products',
							'href'     => $this->url->link('extension/module/editinline', 'user_token=' . $this->session->data['user_token'], true),
							'children' => array()
						);
					}
			...
			/* gallery */						
			$gallerydashbord = array();
		
			if ($this->user->hasPermission('access', 'extension/gallerydashboard')) {		
				$gallerydashbord[] = array(
			...
			if ($gallerydashbord) {					
				$data['menus'][] = array(
					'id'       => 'menu-extension',
					'icon'	   => 'fa fa-photo fa-fw', 
					'name'	   => $this->language->get('text_gallerydashboard'),
					'href'     => '',
					'children' => $gallerydashbord
				);		
			}
			/* gallery */

      // Price List
      if ($this->user->hasPermission('access', 'extension/module/tmdwhatsapp')) {
      $data['menus'][] = array(
        'id'       => 'menu-tmdwhatsapp',
        'icon'     => 'fa fa-whatsapp',
        'name'     => $this->language->get('text_whatsapp'),
