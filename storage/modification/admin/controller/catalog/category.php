...
class ControllerCatalogCategory extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_category->addCategory($this->request->post);
                ...
                if(isset($this->request->get['editinline'])){
                    if (version_compare(VERSION, '2.2.0.0') >= 0) { 
                        $this->response->redirect($this->url->link('extension/module/editinline/success', 'user_token=' . $this->session->data['user_token'], true));
                    } else {
                        $this->response->redirect($this->url->link('extension/module/editinline/success', 'user_token=' . $this->session->data['user_token'], 'SSL'));
                    }
                }
	...
	protected function getForm() {
                ...
                if(isset($this->request->get['editinline'])){
                    $data['editinline'] = $this->request->get['editinline'];
                } else {
                    $data['editinline'] = false;
                }
		...
		if (!isset($this->request->get['category_id'])) {
			$data['action'] = $this->url->link('catalog/category/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
                ...
                if(isset($this->request->get['editinline'])){
                    if (version_compare(VERSION, '2.2.0.0') >= 0) { 
                        $data['action'] = $this->url->link('catalog/category/add', 'user_token=' . $this->session->data['user_token'] . $url . '&editinline=true', true);
                    } else {
                        $data['action'] = $this->url->link('catalog/category/add', 'user_token=' . $this->session->data['user_token'] . $url . '&editinline=true', 'SSL');
                    }
                }
			...
			$data['action'] = $this->url->link('catalog/category/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $this->request->get['category_id'] . $url, true);
                ...
                if(isset($this->request->get['editinline'])){
                    if (version_compare(VERSION, '2.2.0.0') >= 0) { 
                        $data['action'] = $this->url->link('catalog/category/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $this->request->get['category_id'] . $url . '&editinline=true', true);
                    } else {
                        $data['action'] = $this->url->link('catalog/category/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $this->request->get['category_id'] . $url . '&editinline=true', 'SSL');
                    }
                }
		...
		if (isset($this->request->post['parent_id'])) {
			...
			$data['parent_id'] = 0;
              ...
              if(isset($this->request->get['parent_id'])){
                    ...
                    $parent_info = $this->model_catalog_category->getCategory($this->request->get['parent_id']);
                    if(!empty($parent_info)) {
                         $data['path'] = $parent_info['path'] ? $parent_info['path'] . ' &gt; ' . $parent_info['name'] : $parent_info['name'];
                    } else {
                        $data['path'] = '';
                    }
